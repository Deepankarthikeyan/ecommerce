...
<body>
    <div class="container mt-5">
        <h3 class="text-center mb-3">FEATURE PRODUCT LIST</h3>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center"><?php echo $product['fp_name'] ?></td>
                    <td class="text-center"><?php echo $product['fp_price'] ?></td>
                    <td class="text-center">
                        <a href="<?php echo base_url("feature_product_details/{$product['fp_id']}") ?>"
                            class="btn btn-primary mt-2"><i class="fa-solid fa-eye"></i></a>    
                        <a href="<?php echo base_url("delete_feature_product/{$product['fp_id']}") ?>" id="delete"
